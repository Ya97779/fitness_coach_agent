module.exports = {
  ...
  exercises: [
    // === 上胸 ===
    {
      ...
      cover: 'https://gzyhm.xyz/guide/上斜杠铃卧推.gif',
      equipment: '杠铃、可调卧推凳',
    ...
    },
    {
      ...
      cover: 'https://gzyhm.xyz/guide/上斜哑铃卧推.gif',
      equipment: '哑铃、可调卧推凳',
      targetMuscles: ['胸大肌上束', '三角肌前束', '肱三头肌'],
    ...
    },
    {
      ...
      cover: 'https://gzyhm.xyz/guide/低位龙门架夹胸.gif',
      equipment: '龙门架',
    ...
    // === 整体 ===
    {
      ...
      cover: 'https://gzyhm.xyz/guide/杠铃卧推.gif',
      equipment: '杠铃、卧推凳',
    ...
    },
    {
      ...
      cover: 'https://gzyhm.xyz/guide/哑铃卧推.gif',
      equipment: '哑铃、卧推凳',
      targetMuscles: ['胸大肌', '三角肌前束', '肱三头肌'],
      video: '',
      steps: [
    ...
    },
    {
      ...
      cover: 'https://gzyhm.xyz/guide/俯卧撑.gif',
      equipment: '无（徒手）',
    ...
    // === 下胸 ===
    {
      ...
      cover: 'https://gzyhm.xyz/guide/双杠臂屈伸.gif',
      equipment: '双杠',
    ...
    },
    {
      ...
      cover: 'https://gzyhm.xyz/guide/龙门架夹胸.gif',
      equipment: '龙门架',
    ...
    },
    {
      ...
      cover: 'https://gzyhm.xyz/guide/下斜卧推.gif',
      equipment: '杠铃、下斜卧推凳',
