module.exports = {
  ...
  exercises: [
    // === 上胸 ===
    {
      ...
      cover: 'https://gzyapi.gzyhm.xyz/guide/incline-bench-press.gif',
      equipment: '杠铃、可调卧推凳',
    ...
    },
    {
      ...
      cover: 'https://gzyapi.gzyhm.xyz/guide/incline-dumbbell-press.gif',
      equipment: '哑铃、可调卧推凳',
      targetMuscles: ['胸大肌上束', '三角肌前束', '肱三头肌'],
    ...
    },
    {
      ...
      cover: 'https://gzyapi.gzyhm.xyz/guide/low-cable-crossover.gif',
      equipment: '龙门架',
    ...
    // === 整体 ===
    {
      ...
      cover: 'https://gzyapi.gzyhm.xyz/guide/barbell-bench-press.gif',
      equipment: '杠铃、卧推凳',
    ...
    },
    {
      ...
      cover: 'https://gzyapi.gzyhm.xyz/guide/dumbbell-bench-press.gif',
      equipment: '哑铃、卧推凳',
      targetMuscles: ['胸大肌', '三角肌前束', '肱三头肌'],
      video: '',
      steps: [
    ...
    },
    {
      ...
      cover: 'https://gzyapi.gzyhm.xyz/guide/push-up.gif',
      equipment: '无（徒手）',
    ...
    // === 下胸 ===
    {
      ...
      cover: 'https://gzyapi.gzyhm.xyz/guide/dips.gif',
      equipment: '双杠',
    ...
    },
    {
      ...
      cover: 'https://gzyapi.gzyhm.xyz/guide/cable-crossover.gif',
      equipment: '龙门架',
    ...
    },
    {
      ...
      cover: 'https://gzyapi.gzyhm.xyz/guide/decline-bench-press.gif',
      equipment: '杠铃、下斜卧推凳',
