module.exports = {
  ...
  exercises: [
    // === 背阔肌 ===
    {
      ...
      cover: 'https://gzyapi.gzyhm.xyz/guide/pull-up.gif',
      equipment: '单杠',
    ...
    },
    {
      ...
      cover: 'https://gzyapi.gzyhm.xyz/guide/lat-pulldown.gif',
      equipment: '高位下拉机',
      targetMuscles: ['背阔肌', '大圆肌', '肱二头肌'],
      video: '',
    ...
    },
    {
      ...
      cover: 'https://gzyapi.gzyhm.xyz/guide/straight-arm-pulldown.gif',
      equipment: '龙门架',
    ...
    // === 上背 ===
    {
      ...
      cover: 'https://gzyapi.gzyhm.xyz/guide/barbell-row.gif',
      equipment: '杠铃',
    ...
    },
    {
      ...
      cover: 'https://gzyapi.gzyhm.xyz/guide/seated-row.gif',
      equipment: '坐姿划船机',
    ...
    },
    {
      ...
      cover: 'https://gzyapi.gzyhm.xyz/guide/reverse-fly.gif',
      equipment: '哑铃或反向飞鸟机',
    ...
    // === 下背 ===
    {
      ...
      cover: 'https://gzyapi.gzyhm.xyz/guide/deadlift.gif',
      equipment: '杠铃',
    ...
    },
    {
      ...
      cover: 'https://gzyapi.gzyhm.xyz/guide/hyperextension.gif',
      equipment: '山羊挺身凳',
