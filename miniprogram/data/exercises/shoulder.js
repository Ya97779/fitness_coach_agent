module.exports = {
  ...
  exercises: [
    // === 前束 ===
    {
      ...
      cover: 'https://gzyapi.gzyhm.xyz/guide/overhead-press.gif',
      equipment: '杠铃',
    ...
    },
    {
      ...
      cover: 'https://gzyapi.gzyhm.xyz/guide/arnold-press.gif',
      equipment: '哑铃',
    ...
    },
    {
      ...
      difficulty: 'beginner',
      summary: '孤立三角肌前束',
      cover: 'https://gzyapi.gzyhm.xyz/guide/front-raise.gif',
      equipment: '哑铃',
      targetMuscles: ['三角肌前束'],
      video: '',
    ...
    // === 中束 ===
    {
      ...
      cover: 'https://gzyapi.gzyhm.xyz/guide/lateral-raise.gif',
      equipment: '哑铃',
      targetMuscles: ['三角肌中束'],
      video: '',
    ...
    },
    {
      ...
      difficulty: 'beginner',
      summary: '全程恒定张力的中束训练',
      cover: 'https://gzyapi.gzyhm.xyz/guide/cable-lateral-raise.gif',
      equipment: '龙门架',
      targetMuscles: ['三角肌中束'],
      video: '',
    ...
    },
    {
      ...
      cover: 'https://gzyapi.gzyhm.xyz/guide/face-pull.gif',
      equipment: '龙门架 + 绳索',
