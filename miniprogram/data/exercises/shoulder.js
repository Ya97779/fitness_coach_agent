module.exports = {
  ...
  exercises: [
    // === 前束 ===
    {
      ...
      cover: 'https://gzyhm.xyz/guide/站姿推举.jpg',
      equipment: '杠铃',
    ...
    },
    {
      ...
      cover: 'https://gzyhm.xyz/guide/阿诺德推举.jpg',
      equipment: '哑铃',
    ...
    },
    {
      ...
      difficulty: 'beginner',
      summary: '孤立三角肌前束',
      cover: 'https://gzyhm.xyz/guide/前平举.jpg',
      equipment: '哑铃',
      targetMuscles: ['三角肌前束'],
      video: '',
    ...
    // === 中束 ===
    {
      ...
      cover: 'https://gzyhm.xyz/guide/侧平举.jpg',
      equipment: '哑铃',
      targetMuscles: ['三角肌中束'],
      video: '',
    ...
    },
    {
      ...
      difficulty: 'beginner',
      summary: '全程恒定张力的中束训练',
      cover: 'https://gzyhm.xyz/guide/绳索侧平举.jpg',
      equipment: '龙门架',
      targetMuscles: ['三角肌中束'],
      video: '',
    ...
    // === 后束 ===
    {
      ...
      cover: 'https://gzyhm.xyz/guide/俯身飞鸟.jpg',
      equipment: '哑铃',
    ...
    },
    {
      ...
      cover: 'https://gzyhm.xyz/guide/面拉.jpg',
      equipment: '龙门架 + 绳索',
