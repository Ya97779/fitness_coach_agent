module.exports = {
  ...
  exercises: [
    ...
    },
    {
      ...
      video: '',
      steps: ['每只手拿着哑铃，坐在带有背部支撑的凳子上，将哑铃垂直放在大腿上方。', '用大腿将哑铃一个一个地抬到肩膀高度，帮助将它们推到合适的位置。', '一定要转动手腕，使手掌朝前。这是你的起始位置。', '呼气并向上推动哑铃，直到手臂接近伸直', '在顶部收缩位置短暂停顿后，在吸气的同时缓慢将重物放回耳朵附近'],
      tips: ['大臂向内略微收缩15°左右，动作流畅，推举同步', '控制速度，不要甩动，注意安全'],
      mistakes: [{ wrong: '最上方耸肩', fix: '保持动作流畅同步' }],
