module.exports = {
  ...
  exercises: [
    ...
    },
    {
      ...
      cover: 'https://gzyapi.gzyhm.xyz/guide/阿诺德推举.gif',
      equipment: '哑铃',
    ...
    },
    {
      ...
      difficulty: 'beginner',
      summary: '孤立三角肌前束',
      cover: 'https://gzyapi.gzyhm.xyz/guide/前平举.gif',
      equipment: '哑铃',
      targetMuscles: ['三角肌前束'],
      video: '',
    ...
    // === 中束 ===
    {
      ...
      cover: 'https://gzyapi.gzyhm.xyz/guide/侧平举.gif',
      equipment: '哑铃',
      targetMuscles: ['三角肌中束'],
      video: '',
    ...
    },
    {
      ...
      cover: 'https://gzyapi.gzyhm.xyz/guide/面拉.gif',
      equipment: '龙门架 + 绳索',
