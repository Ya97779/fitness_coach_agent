module.exports = {
  ...
  exercises: [
    // === 肱二头肌 ===
    {
      ...
      cover: 'https://gzyapi.gzyhm.xyz/guide/barbell-curl.gif',
      equipment: '杠铃',
    ...
    },
    {
      ...
      cover: 'https://gzyapi.gzyhm.xyz/guide/hammer-curl.gif',
      equipment: '哑铃',
    ...
    },
    {
      ...
      difficulty: 'beginner',
      summary: '孤立二头肌，防止借力',
      cover: 'https://gzyapi.gzyhm.xyz/guide/preacher-curl.gif',
      equipment: '牧师凳 + 哑铃/杠铃',
      targetMuscles: ['肱二头肌'],
      video: '',
    ...
    // === 肱三头肌 ===
    {
      ...
      cover: 'https://gzyapi.gzyhm.xyz/guide/close-grip-bench.gif',
      equipment: '杠铃、卧推凳',
    ...
    },
    {
      ...
      cover: 'https://gzyapi.gzyhm.xyz/guide/tricep-pushdown.gif',
      equipment: '龙门架 + 绳索',
      targetMuscles: ['肱三头肌'],
      video: '',
    ...
    },
    {
      ...
      difficulty: 'intermediate',
      summary: '三头肌长头重点刺激',
      cover: 'https://gzyapi.gzyhm.xyz/guide/skull-crusher.gif',
    ...
    // === 小臂 ===
    {
      ...
      difficulty: 'beginner',
      summary: '前臂屈肌群孤立训练',
      cover: 'https://gzyapi.gzyhm.xyz/guide/wrist-curl.gif',
      equipment: '哑铃',
      targetMuscles: ['前臂屈肌群'],
      video: '',
    ...
    },
    {
      ...
      cover: 'https://gzyapi.gzyhm.xyz/guide/reverse-wrist-curl.gif',
      equipment: '哑铃',
      targetMuscles: ['前臂伸肌群'],
      video: '',
    ...
    },
    {
      ...
      cover: 'https://gzyapi.gzyhm.xyz/guide/farmer-walk.gif',
      equipment: '哑铃/壶铃',
