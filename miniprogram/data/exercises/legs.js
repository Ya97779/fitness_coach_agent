module.exports = {
  ...
  exercises: [
    // === 股四头肌 ===
    {
      ...
      cover: 'https://gzyapi.gzyhm.xyz/guide/squat.gif',
      equipment: '杠铃',
    ...
    },
    {
      ...
      cover: 'https://gzyapi.gzyhm.xyz/guide/leg-press.gif',
      equipment: '腿举机',
    ...
    },
    {
      ...
      difficulty: 'beginner',
      summary: '股四头肌孤立动作',
      cover: 'https://gzyapi.gzyhm.xyz/guide/leg-extension.gif',
      equipment: '腿屈伸机',
      targetMuscles: ['股四头肌'],
      video: '',
    ...
    // === 腘绳肌 ===
    {
      ...
      difficulty: 'beginner',
      summary: '腘绳肌孤立动作',
      cover: 'https://gzyapi.gzyhm.xyz/guide/leg-curl.gif',
      equipment: '腿弯举机',
      targetMuscles: ['腘绳肌'],
      video: '',
    ...
    },
    {
      ...
      cover: 'https://gzyapi.gzyhm.xyz/guide/romanian-deadlift.gif',
      equipment: '杠铃',
    ...
    // === 臀部 ===
    {
      ...
      difficulty: 'intermediate',
      summary: '臀大肌最佳孤立动作',
      cover: 'https://gzyapi.gzyhm.xyz/guide/hip-thrust.gif',
      equipment: '杠铃、卧推凳',
      targetMuscles: ['臀大肌'],
      video: '',
    ...
    },
    {
      ...
      cover: 'https://gzyapi.gzyhm.xyz/guide/bulgarian-split-squat.gif',
      equipment: '哑铃、卧推凳',
