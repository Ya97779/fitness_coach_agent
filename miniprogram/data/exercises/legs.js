module.exports = {
  ...
  exercises: [
    // === 股四头肌 ===
    {
      ...
      cover: 'https://gzyhm.xyz/guide/深蹲.jpg',
      equipment: '杠铃',
    ...
    },
    {
      ...
      cover: 'https://gzyhm.xyz/guide/腿举.jpg',
      equipment: '腿举机',
    ...
    },
    {
      ...
      difficulty: 'beginner',
      summary: '股四头肌孤立动作',
      cover: 'https://gzyhm.xyz/guide/腿屈伸.jpg',
      equipment: '腿屈伸机',
      targetMuscles: ['股四头肌'],
      video: '',
    ...
    // === 腘绳肌 ===
    {
      ...
      difficulty: 'beginner',
      summary: '腘绳肌孤立动作',
      cover: 'https://gzyhm.xyz/guide/腿弯举.jpg',
      equipment: '腿弯举机',
      targetMuscles: ['腘绳肌'],
      video: '',
    ...
    },
    {
      ...
      cover: 'https://gzyhm.xyz/guide/罗马尼亚硬拉.jpg',
      equipment: '杠铃',
    ...
    // === 臀部 ===
    {
      ...
      difficulty: 'intermediate',
      summary: '臀大肌最佳孤立动作',
      cover: 'https://gzyhm.xyz/guide/臀推.jpg',
      equipment: '杠铃、卧推凳',
      targetMuscles: ['臀大肌'],
      video: '',
    ...
    },
    {
      ...
      cover: 'https://gzyhm.xyz/guide/保加利亚分腿蹲.jpg',
      equipment: '哑铃、卧推凳',
