  ...
  exercises: [
    {
      ...
      difficulty: 'beginner',
      summary: '腹直肌基础孤立动作',
      cover: 'https://gzyapi.gzyhm.xyz/guide/crunch.gif',
      equipment: '瑜伽垫',
    ...
    },
    {
      ...
      difficulty: 'beginner',
      summary: '核心抗伸展等长收缩训练',
      cover: 'https://gzyapi.gzyhm.xyz/guide/plank.gif',
      equipment: '瑜伽垫',
    ...
    },
    {
      ...
      difficulty: 'beginner',
      summary: '腹斜肌旋转训练',
      cover: 'https://gzyapi.gzyhm.xyz/guide/russian-twist.gif',
      equipment: '瑜伽垫、药球（可选）',
    ...
    },
    {
      ...
      summary: '下腹和髋屈肌复合训练',
      cover: 'https://gzyapi.gzyhm.xyz/guide/hanging-leg-raise.gif',
      equipment: '单杠',
    ...
    },
    {
      ...
      cover: 'https://gzyapi.gzyhm.xyz/guide/dead-bug.gif',
      equipment: '瑜伽垫',
    ...
    },
    {
      ...
      difficulty: 'beginner',
      summary: '腹斜肌等长收缩训练',
      cover: 'https://gzyapi.gzyhm.xyz/guide/side-plank.gif',
      equipment: '瑜伽垫',
