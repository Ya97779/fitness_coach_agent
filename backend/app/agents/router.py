...
NUTRITION_KEYWORDS = [
    ...
    "营养师", "营养专家", "营养助手",
    # 餐次
    "早餐", "午餐", "晚餐", "早饭", "午饭", "晚饭", "加餐", "零食", "夜宵",
    # 记录意图
    "吃了", "喝了", "吃的", "喝的", "吃了一个", "喝了一杯", "吃了一碗",
    "帮我记录", "记录一下", "帮我记", "记一下",
    "帮我记录饮食", "帮我记录食物", "记录一下饮食", "记录饮食", "记录食物",
    # 营养概念
    "食物", "饮食", "营养", "热量", "卡路里", "蛋白质", "脂肪", "碳水",
...
def _keyword_match(text: str) -> str:
    ...
    print(f"[router] 关键词匹配: nutrition={nutrition_score}, fitness={fitness_score}, text={text[:50]}")
